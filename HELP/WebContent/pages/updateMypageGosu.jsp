...
<body>
	<div id="container">
		<div class="main_contents">
			<!-- 본문영역 -->
			<form action="updateMypageReg.help" method="post">
			<div class="contents_inner">
				<div class="xans-element- xans-member xans-member-join ">


					<h3 style="font-size: 30px; font-weight: bold;">고수 회원 정보 수정</h3>
					<br>
					<div class="boardWrite">
						<table border="1" summary="">
							<tbody>
								<tr>
									<th scope="row" id="nameTitle" style="font-size: 18px;">이름
										<img
									...
									<td><span id="nameContents">기존 이름 : <input id=""
											...
											&nbsp&nbsp 수정할 이름 : <input id="m_name"
											name="m_name" fw-filter="isFill&isMax[30]" fw-label="이름"
											fw-msg="" class="ec-member-name" placeholder="수정할 이름을 입력하세요"
								...
								<tr>
									...
									<td>기존 전화 번호 : <input type="text" value="${member.m_tel}" disabled="disabled">
										...
										-<input id="mobile2" name="m_tel2" maxlength="4"value="" type="text" />
										-<input id="mobile3" name="m_tel3" maxlength="4" value="" type="text" />
									</td>
								</tr>

								<tr>
									<th scope="row" style="font-size: 18px;">이메일 <img
										src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif"
										alt="필수" /></th>
									<td>기존 이메일 : <input  value="${member.m_email }" type="text" disabled="disabled"/>
									<br><br>수정할 이메일 : <input id="email1" name="m_email"
										value="" type="text" />@<input
										id="email2" name="email2" fw-filter="isFill" fw-label="이메일"
										readonly="readonly" value=""
										type="text" /><span><select id="email3" name="m_email2">
								...
								<tr>
									<th scope="row" style="font-size: 18px;">소개 입력 <img
										...
										alt="필수" /></th>
									<td>
										<textarea rows="5" cols="30" name="m_intro">${member.m_intro }</textarea>
									</td>
								</tr>
							</tbody>
						</table>
					...
					<div class="agreeArea">
						<div class="agree">
							...
							<p>
								...
								정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 취급위탁의 경우 등 관련 법령에 달리 정함이 있는
								경우에는 그에 따릅니다.
							</p>
							<p>
							...
							<p>
								...
								개인정보를 이용하지 않습니다.<br>⑦ “몰”은 개인정보 보호를 위하여 이용자의 개인정보를 취급하는 자를
						...
						<p class="check">
							<span>이용약관에 동의하십니까?</span> <input id="agree_service_check0"
								...
								fw-msg="이용약관에 동의 하세요" value="1" type="checkbox" checked="checked"/><label
