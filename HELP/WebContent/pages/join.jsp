		...
		<div class="main_contents">
			...
			<div class="contents_inner">
				<div class="xans-element- xans-member xans-member-join ">
					...
					<h3 style="font-size: 30px; font-weight: bold; font-family: 'Cooper Black';">INFOMATION</h3>
					<br><br>
					<div class="boardWrite">
						<table border="1" summary="">
							<tbody>
								<tr>
									<th scope="row" style="font-size: 18px;">ID <img
								...
								<tr>
									...
									</select>-<input id="mobile2" name="m_tel2" maxlength="4"
										fw-filter="isNumber&isFill" fw-label="휴대전화" fw-alone="N"
								...
								<tr>
									<th scope="row" style="font-size: 18px;">이메일 <img
										src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif"
										alt="필수" /></th>
									<td><input id="email1" name="m_email" fw-filter="isFill"
										...
										type="text" /><select id="email3" name="m_email2" required>
