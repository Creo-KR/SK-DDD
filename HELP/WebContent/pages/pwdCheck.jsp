		...
		<div class="main_contents">
			...
			<div class="contents_inner">
				<div class="xans-element- xans-member xans-member-join ">
					...
					<h3 style="font-size: 30px; font-weight: bold;">정보를 수정하기 위해 비밀번호를 입력하세요</h3>
					<br>
					...
					<span class="btnArea center smp-btn-reg">
						<a><button id="joinButton" type="submit" style="cursor: pointer;">CONFIRM</button></a>
					</span>
