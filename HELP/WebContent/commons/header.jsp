...
<div id="header">
	...
	<div id="header_inner">
		...
		<div id="util">
			...
			<div class="certify logon" id="idlogout" style="display: none;">
				<span class="name"></span><span class="time" id="time"><a
		...
		<script type='text/javascript'>
			...
			function sbsb() {
				...
				if ($("form[name=contactfrm]").find("input[name=stxt]").val()
						.split(" ").join("") == "") {
					alert("검색어를 입력해주세요.");
					$("form[name=contactfrm]").find("input[name=stxt]").val("");
					$("form[name=contactfrm]").find("input[name=stxt]").focus();
					...
					<div class="submenu" style="display: none;">
						<div class="submenu_inner open">
							<ul>
								...
								<li><a
									href="/kor/subpage/contents.asp?cn=GDIKDUPG&amp;ln=0QVMFJEJ&amp;sb=QC0RV9RA&amp;tb=4P5MJRG">정보공개책임관</a>
