...
<body class="">
	<div id="mainCarousel" class="hero-container hero01">
		<div class="container">
			<div class="text-wrap">
				<h1 class="with-headline-btn" style="font-size: 30px;">H.E.L.P가
					딱! 맞는 고수를 소개해 드려요</h1>
					...
					<div id="id_input_group_wrap" class="input-group">
						<input type="text" class="form-control search-keyword"
							...
							<button id="bbb" class="btn btn-primary btn-md" type="submit">
								고수찾기</button> <!-- <button class="btn btn-primary btn-md" id="findGosu" type="submit">
								<i class="fa fa-search visible-xs" aria-hidden="true" class=""></i>
								<span class="hidden-xs">고수찾기</span> --> <!-- <button id="bbb" class="btn btn-primary btn-md" type="submit" style="background-color: #555; border-color: #555;">
								<i class="fa fa-search visible-xs" aria-hidden="true" class=""></i>
	...
	<c:if test="${sessionScope.UTYPE == 1}">
		...
		<div class="content" style="height: 200px; width: 0px; margin: auto;">
			...
			<div id="categoryBox"
				style="position: relative; width: 100%; left: 50%; margin-left: -435px;">
				<!-- <div id="categoryBox"> -->
				<h1 class="title">Slide Down Box Menu with jQuery and CSS3</h1>
				<ul id="sdt_menu" class="sdt_menu">
					<li style="border: 1px solid #555;"><a
						href="getCategoryRequest.help?category=1"> <img
							src="${pageContext.request.contextPath}/images/piano.jpg" alt="" />
							<span class="sdt_active"></span> <span class="sdt_wrap"> <span
								class="sdt_link">피아노</span> <span class="sdt_descr">Learn
									the piano</span>
						</span>
					</a></li>
					<li style="border: 1px solid #555;"><a
						href="getCategoryRequest.help?category=2"> <img
							src="${pageContext.request.contextPath}/images/move.jpg" alt="" />
							<span class="sdt_active"></span> <span class="sdt_wrap"> <span
								class="sdt_link">이사</span> <span class="sdt_descr">Move
									house</span>
						</span>
					</a></li>

					<li style="border: 1px solid #555;"><a
						href="getCategoryRequest.help?category=3"> <img
							src="${pageContext.request.contextPath}/images/webDevelop.jpg"
							alt="" /> <span class="sdt_active"></span> <span
							class="sdt_wrap"> <span class="sdt_link">웹 개발</span> <span
								class="sdt_descr">Do web development</span>
						</span>
					</a></li>
					<li style="border: 1px solid #555;"><a
						href="getCategoryRequest.help?category=4"> <img
							src="${pageContext.request.contextPath}/images/potoshop.jpg"
							alt="" /> <span class="sdt_active"></span> <span
							class="sdt_wrap"> <span class="sdt_link">포토샵</span> <span
								class="sdt_descr">Learn Photoshop</span>
						</span>
					</a></li>
					<li style="border: 1px solid #555;"><a
						href="getCategoryRequest.help?category=5"> <img
							src="${pageContext.request.contextPath}/images/wedding.jpg"
							alt="" /> <span class="sdt_active"></span> <span
							class="sdt_wrap"> <span class="sdt_link">결혼</span> <span
								class="sdt_descr">Prepare for marriage</span>
						</span>
					</a></li>
